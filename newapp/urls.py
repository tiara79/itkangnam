...
# 질문게시판 만들기
    path('question/qna/', base_views.qna, name='qna'),

# 전제 상품 리스트 page [21/04/26]
    path('infoIndex/',base_views.infoIndex, name='infoIndex'),

#  세부 상품 리스트 page [21/04/26]
    path('infoTop/',base_views.infoTop, name='infoTop'),
    path('infoJean/',base_views.infoJean, name='infoJean'),
    path('infoOuter/',base_views.infoOuter, name='infoOuter'),

#  단일 상품 리스트 page [21/04/26]
    path('infoTop/topInfo/',base_views.topInfo, name='topInfo'),
    path('infoJean/jeanInfo/', base_views.jeanInfo, name='jeanInfo'),
    path('infoOuter/outerInfo/', base_views.outerInfo, name='outerInfo'),

    path('admin/openMenu/', base_views.openMenu, name='openMenu'),
# 상품가이드 page 생성 [21/04/29]
    path('admin/shoppingGuide/', base_views.shoppingGuide, name='shoppingGuide'),
]
